...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.15.67', '192.168.110.49', '192.168.110.79','192.168.110.170','192.168.110.164']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # You can add other global template directories if needed
        ],
        'APP_DIRS': True,  # This should be True to tell Django to look for app templates
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'qrchef7@gmail.com'  # <-- Replace with your Gmail address
EMAIL_HOST_PASSWORD = 'xagf hxtz stnr hsdj'   # <-- Replace with your Gmail app password
